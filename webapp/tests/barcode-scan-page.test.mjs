...
test('meal scanner shows the three most-used foods above a half-height camera', async () => {
  ...
  assert.match(cameraView.querySelector('video').className, /aspect-\[3\/2\]/)
  assert.match(cameraView.querySelector('video').className, /sm:aspect-\[32\/9\]/)
  assert.doesNotMatch(cameraView.querySelector('video').className, /h-\[50vh\]/)
  assert.match(cameraView.querySelector('canvas').className, /aspect-\[3\/2\]/)
  assert.match(cameraView.querySelector('canvas').className, /sm:aspect-\[32\/9\]/)
  assert.doesNotMatch(cameraView.querySelector('canvas').className, /h-\[50vh\]/)
